...
%         myhist(C);grid on;
        ...
        %%  1. transfer train; only train the n-3:end layers
        ...
        [predictedLabels scoresToReturn] = classify(netTransfer,0,testFeatures);
        testLabels = test_data.Labels;
        accuracy = sum(predictedLabels==testLabels)/numel(predictedLabels)
